...
class face_analysis():
    ...
    def handler_face(self, img_path):
        print(img_path)
        face_info = DeepFace.analyze(img_path = img_path,
        actions = ['age', 'gender', 'race', 'emotion']
        )

        return self.translator(face_info[0]["age"], face_info[0]["dominant_gender"], face_info[0]["dominant_race"], face_info[0]["dominant_emotion"])


    def translator(self, age, gender, race, emotion):
